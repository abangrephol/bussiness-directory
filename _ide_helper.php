...
namespace {
    ...
    class Theme extends \Teepluss\Theme\Facades\Theme{
        ...
        public static function partialWithLayout($view, $args = array()){
            return \Teepluss\Theme\Theme::partialWithLayout($view, $args);
        }
        ...
        public static function loadPartial($view, $partialDir, $args){
            return \Teepluss\Theme\Theme::loadPartial($view, $partialDir, $args);
        }
        ...
        public static function watchPartial($view, $args = array()){
            return \Teepluss\Theme\Theme::watchPartial($view, $args);
        }
         ...
         * @return \Teepluss\Theme\Teepluss\Theme\Widget 
         * @static 
         */
         ...
         *
         * @param mixed $view
         * @param \Teepluss\Theme\closure $callback
         * @return void 
         * @static 
         */
        public static function partialComposer($view, $callback, $layout = null){
            \Teepluss\Theme\Theme::partialComposer($view, $callback, $layout);
        }
         ...
         *
         * @param \Teepluss\Theme\Cookie $cookie
         * @return \Teepluss\Theme\Theme 
         * @static 
         */
         ...
         * @return \Teepluss\Theme\Response 
         * @static 
         */

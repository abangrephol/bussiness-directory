<div id="page-content">
    <div class="container">
        <div class="page-content">
            <div class="about-us">
                <h3><strong>About</strong> WN Directory</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="member-details">
                            <div class="porfile-pic">
                                <img src="{{ URL::to('/themes/default/assets') }}/img/content/team-member-1.jpg" alt="">
                            ...
                            <h3><a href="#">Abu Antar</a></h3>

                            <p class="title">Ceo</p>

                            <p>Donec venenatis, turpis vel hendrerit interdum,
                                dui ligula ultricies purus, sed posuere libero dui id orci.</p>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="member-details">
                            <div class="porfile-pic">
                                <img src="{{ URL::to('/themes/default/assets') }}/img/content/team-member-2.jpg" alt="">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="member-details">
                            <div class="porfile-pic">
                                <img src="{{ URL::to('/themes/default/assets') }}/img/content/team-member-3.jpg" alt="">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="member-details">
                            <div class="porfile-pic">
                                <img src="{{ URL::to('/themes/default/assets') }}/img/content/team-member-4.jpg" alt="">

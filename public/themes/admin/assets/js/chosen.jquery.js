...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      option_el.innerHTML = this.useTemplate(option);//option.search_text;
    ...
    AbstractChosen.prototype.winnow_results = function() {
      var escapedSearchText, html, option, regex, results, results_group, searchText, startpos, text, zregex, _i, _len, _ref;
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.single_set_selected_text = function(text) {
	  ...
	  return this.selected_item.find("span").first().html(text);

            ...
            $.each(gm.options.controlButtons, function(i, val){
			  ...
			  */
			  var label = val[0];
				...
				buttons.push("<a title='" + gm.options.addRow + " " + _class + "' class='" + gm.options.controlButtonClass + " add" + _class + "'><span class='" + gm.options.controlButtonSpanClass + "'></span> " + label + " </a>"); //" + _class + "
